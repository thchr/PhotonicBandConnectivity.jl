"""
    topology_from_2T1L_xor_1L(nᵀ⁺ᴸ::Vector{Int}, nᴸ::Vector{Int}, 
            BRS_B_Bℤ::Union{BandRepSet, Matrix{Int}, fmpz_mat})         -> TopologyKind
...
- `BRS_B_Bℤ`: a matrix representation of the elementary band representations (EBR) basis,
...
In similarity with its 3-argument parent method, its final argument `BRS_B_Bℤ` must be a
...
function topology_from_2T1L_xor_1L(
    ...
    topology_from_2T1L_xor_1L(nᵀ, nᴸ, nΓ²ᵀ, Γidxs, BRS_B_Bℤ)
end