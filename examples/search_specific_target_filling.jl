...
#filepath     = "/mnt/c/Dropbox (MIT)/Web/thchr.github.io/_assets/"*tablename # specify output path
#tablename    = "connectivity-tr-"*(timereversal ? "invariant" : "broken")*".tex"
#filepath     = "/mnt/c/Dropbox (MIT)/Projects/photonic-topo-sym/band-connectivities/manuscript/tables/"*tablename # specify output path
#io           = open(filepath, "w+")
io           = stdout
verbose      = false
t₀           = time()
